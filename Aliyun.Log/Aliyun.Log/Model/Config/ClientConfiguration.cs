...
namespace Aliyun.Log.Model.Config
{
    /// <summary>
    /// 表示访问阿里云服务的配置信息。
    /// </summary>
    ...
    {
        private string _userAgent = LogConst.CONST_USER_AGENT_PREFIX + typeof(ClientConfiguration).Assembly.GetName().Version.ToString();

        private int _connectionTimeout = LogConst.DEFAULT_SLS_CONNECT_TIMEOUT;
        private int _maxErrorRetry = LogConst.DEFAULT_SLS_RETRY_TIME;
        private int _readWrtTimeout = LogConst.DEFAULT_SLS_READWRT_TIMEOUT;
        private int _retryInterval = LogConst.DEFAULT_SLS_RETRY_INTERVALBASE;
