...
namespace Aliyun.Log.Model.Communication
{
    internal class ServiceClientImpl : ServiceClient
    {
        ...
        internal class ResponseImpl : ServiceResponse
        {
            ...
            private System.Exception _failure;
            ...
            public override System.Exception Failure
            {
                get
                {
            ...
            private static IDictionary<string, string> GetResponseHeaders(HttpWebResponse response)
            {
                ...
                if (response == null)
                {
                    ...
                    testHeaders.Add(LogConst.NAME_HEADER_AUTH, "LOG mockkeyid:EX2VSCpdyFrcysmBaQ+aokupwcg=");
                    return testHeaders;
                }
#endif
                ...
                for (int i = 0; i < headers.Count; i++)
                {
                    ...
                    result.Add(key,
                               HttpUtil.ReEncode(
                                   value,
                                   HttpUtil.Iso88591Charset,
                                   HttpUtil.UTF8Charset));
                }
...
#region Implementations
    ...
    internal static class HttpFactory
    {
                                              ...
                                              ClientConfiguration configuration)
        {
            ...
            {
                //if (h.Key.CompareTo(LogConst.NAME_HEADER_HOST) == 0)
                //    webRequest.Host = h.Value;
                //else if (h.Key.CompareTo(LogConst.NAME_HEADER_DATE) == 0)
                //    webRequest.Date = DateUtils.ParseRfc822Date(h.Value);
                //if (h.Key.CompareTo(LogConst.NAME_HEADER_CONTENTTYPE) == 0)
    ...
    internal static class HttpExtensions
    {
        ...
        { PlatformID.MacOSX, PlatformID.Unix,PlatformID.Win32NT };
